    ...
    const setCustomValidityMsg = (validityMsg, inputElement) => {
        const inputWrapper = inputElement.closest('.register-form__input-wrapper');
        const validityMsgWrapper = inputWrapper.querySelector('.register-form__custom-validity-wrapper');
    ...
    const validateTextInput = (inputElement, inputValue, minLength, maxLength, customValidityMessage) => {
        ...
        if(noValidateMsg){
            inputElement.classList.add('register-form__input--no-valid');
            return;
        }
        if(!noValidateMsg){
            inputElement.classList.remove('register-form__input--no-valid');
            inputElement.classList.add('register-form__input--validated');
        }
    ...
    const nameInput = document.getElementById('register-form-name-input');
    const priceInput = document.getElementById('register-form-price-input');
    const stockInput = document.getElementById('register-form-stock-input');
    const brandInput = document.getElementById('register-form-brand-input');
    const categoryInput = document.getElementById('register-form-category-input');
    const shortDescriptionInput = document.getElementById('register-form-short-description');
    const longDescriptionInput = document.getElementById('register-form-long-description');
    const ageRankInput = document.getElementById('register-form-long-min-age');
    const photoInput = document.getElementById('register-form-photos');
    ...
    registerValidityInputEvent(nameInput, validateToyName);
    registerValidityInputEvent(priceInput, validatePrice);
    registerValidityInputEvent(stockInput, validateStock);
    registerValidityInputEvent(brandInput, validateBrand);
    registerValidityChangeEvent(categoryInput, validateCategory);
    registerValidityInputEvent(shortDescriptionInput, validateShortDescription);
    registerValidityInputEvent(longDescriptionInput, validateLongDescription);
    registerValidityChangeEvent(ageRankInput, validateAgeRank);
